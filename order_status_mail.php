<?php 
$sqlorder = mysqli_query($conn,"select * from `".$sufix."order` where oid='".$_REQUEST['orderid']."'") ;
...
$walletused = $rows['walletused'];
$paybleamount= $rows['totalcost'] - $rows['walletused'];
$fromc = "Shopurneeds";
$toc = $emailid;
            ...
            <tr>
              <td align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="15" cellspacing="0">
                ...
                <td width="50%" align="left" valign="top" style="color:#002b4f;padding:10px 10px 0;font-weight:600;font-size:15px;line-height:26px"> Dear '.$name.', <br>
                        Your order has been cancelled.</td>
                          ...
                          <tbody>
                            ...
                            if($walletused > 0)
                            {
                                $messagec .='<tr>
                                  ...
                                  <td style="font-size:12px;color:#002b4f">'.Currency.floor($walletused).'</td>
                                </tr>';
                            }
                            ...
                            $messagec .='<tr>
                              ...
                              <th align="left" style="font-size:12px;color:#002b4f">'.Currency.floor($paybleamount).'</th>
                            </tr>
                          </tbody>
                        </table></td>
                    </tr>
