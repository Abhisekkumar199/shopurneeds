												...
												<table border="0" cellpadding="0" cellspacing="0" width="100%">
													...
													<tbody>
														...
														<tr>
															...
															<div class="h2" style="color:#ffffff;font-family:Georgia, serif;min-width:auto !important;font-size:60px;line-height:64px;text-align:center;"><em>Congratulations</em></div>
															...
															<div class="h3-2-center" style="color:#1e1e1e;font-family:Arial, sans-serif;min-width:auto !important;font-size:20px;line-height:26px;text-align:center;letter-spacing:5px;">YOU RECEIVED AN ORDER!</div>
...
<table role="presentation" cellpadding="0">
																					...
																					<table id="m_-6527949812705684337summary">
																						...
																						<tbody>
																							...
																							<tr>
																								...
																								<h3 style="text-align:left;color:#1e1e1e;font-family:Arial, serif;min-width:auto !important;font-size:16px;line-height:26px;">Hello Admin,</h3>
																								...
																								<p style="text-align:left;color:#1e1e1e;font-family:Arial, serif;min-width:auto !important;font-size:16px;line-height:26px;">Seller has just received an order from '.$rowuser['fname'].'&nbsp;'.$rowuser['lname'].' </p>
												...
												<div class="h3-1-center" style="color:#1e1e1e;font-family:Arial, serif;min-width:auto !important;font-size:16px;line-height:26px;text-align:center;">Check order details below or Login to the panel to confirm it.<br />
...
if($row['ringsize']!='') { $sizerb = "Size : ".$row['ringsize']; } 

if($row['banglesize']!='') {  $sizerb = "Bangle Size : ".$row['banglesize'];}
...
$gtotal=($totalcost + $shipprice+$tax1);
																		...
																		$message .='<div class="text-right" style="color:#1e1e1e;font-family:Arial, sans-serif;min-width:auto !important;font-size:14px;line-height:20px;text-align:right;">Tax:</div>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<a href="https://localhost/project/shopurneeds" target="_blank">www.https://localhost/project/shopurneeds</a> | <a href="mailto:mp@https://localhost/project/shopurneeds" target="_blank">mp@https://localhost/project/shopurneeds</a> | Phone: +91 0120-11111111
