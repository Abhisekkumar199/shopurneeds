...
$sqlorder = mysqli_query($conn,"select * from `".$sufix."order` where oid='".$orderid."'") ;
...
<body>
<table width="700" align="center" cellpadding="0" cellspacing="0" style="font-size:13px;font-family:arial,sans-serif;color:#00295e;background:#fcb800;padding:0px">
  <tbody>
    <tr>
      <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="background:#f7f7f7">
          <tbody>
            <tr>
              <td height="70" align="center" valign="middle" style="background-color:#84c225;padding:0px"><table style="color:#00295e;font-size:20px;width:100%">
                  <tbody>
                    <tr>
                      <td height="70" align="center" valign="middle" style="background-color: #84c225;"><a href="https://localhost/project/shopurneeds" style="display:block;border:0;text-decoration:none" target="_blank" data-saferedirecturl=""> <img style="max-width:250px;" src="https://localhost/project/shopurneeds/assets/images/logo.png" class="CToWUd"> </a></td>
            ...
            <tr>
              <td align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="15" cellspacing="0">
                ...
                <td width="50%" align="left" valign="top" style="color:#002b4f;padding:10px 10px 0;font-weight:600;font-size:15px;line-height:26px"> Dear '.$rowuser['fname'].'&nbsp;'.$rowuser['lname'].', <br>
                        Thank you for shopping at https://localhost/project/shopurneeds!</td>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td align="left" valign="top"><table width="100%" border="1" cellspacing="0" cellpadding="5">
                          <tbody>
			                ...
			                $sql_basket = mysqli_query($conn,"select * from `".$sufix."basket` where bid='".$_SESSION['shopid']."'") ;		
                            $totalval=0;
                            $count=1;
                            $totalcost=0;
                            $tax1 = 0;
                            ...
                            while($row=mysqli_fetch_assoc($sql_basket))
                            {
                                ...
                                $messagec .='<tr>
                                  <td><div style="padding-bottom:3px; font-size:12px;">'.$row['productname'].'</div>
                                    ...
                                    <a style="text-decoration:none;display:block;padding-bottom:3px"><img width="80" alt="shopurneeds" src="'.$url.'/uploads/productimage/thumb/'.$row['productimage'].'" class="CToWUd"></a></td>
                    ...
                    <tr>
                      <td width="100%" align="left" valign="top" style="padding:0 10px"><table width="100%" align="right" cellpadding="5" cellspacing="0" border="0">
                          <tbody>
                            <tr>
                              <td align="left" valign="top" width="50%"><table width="100%" cellpadding="5" style="border:1px solid #fcb800" cellspacing="0">
                                  <tbody>
                                    <tr valign="top" style="min-height:90px">
                          <td style="font-weight:600;font-size:15px;color:#002b4f;height:20px;background-color:#fcb800;border:1px solid #fcb800" valign="middle">Payment Method:</td>
                                    </tr>
                                  </tbody>
                                </table></td>
                              <td align="left" valign="top"><table cellpadding="5" width="100%" style="border:1px solid #fcb800" cellspacing="0">
                                  <tbody>
                                    <tr valign="top" style="min-height:90px">
                                      <td style="font-weight:600;font-size:15px;color:#002b4f;height:20px;border:1px solid #fcb800;text-align:center" valign="middle">'.$paytpemail.'</td>
                                    </tr>
                                  </tbody>
                                </table></td>
                            </tr>
                    ...
                    <tr>
                      <td width="100%" align="left" valign="top" style="padding:0 10px"><table width="100%" align="right" cellpadding="5" cellspacing="0" border="0">
                          <tbody>
                            <tr>
                      <td align="left" valign="top" width="50%" style="padding-bottom:20px"><table width="100%" cellpadding="5" style="border:3px solid #fcb800" cellspacing="0">
                                  <tbody>
                                    <tr valign="top" style="min-height:80px">
                                      <td style="font-weight:600;font-size:15px;color:#002b4f;height:20px;background-color:#fcb800" valign="middle">Billing Information:</td>
                                    </tr>
                                    <tr>
    ...
    $billcountry = mysqli_fetch_assoc(mysqli_query($conn,"select countryname from ".$sufix."country where countrycode='".$rowuser['billing_country']."'"));  $billcountry['countryname']; $message .='<br>'.
                                        'T:'.$rowuser['billing_mobile'].'</td>
                                    </tr>
                                  </tbody>
                                </table></td>
                              <td align="left" valign="top" style="padding-bottom:20px"><table cellpadding="5" width="100%" style="border:3px solid #fcb800" cellspacing="0">
                                  <tbody>
                                    <tr valign="top" style="min-height:80px">
                                      <td style="font-weight:600;font-size:15px;color:#002b4f;height:20px;background-color:#fcb800" valign="middle">Shipping Information:</td>
                                    </tr>
                                    <tr>
    ...
    $billcountry2 = mysqli_fetch_assoc(mysqli_query($conn,"select countryname from ".$sufix."country where countrycode='".$rowuser['deliver_country']."'"));  $billcountry2['countryname']; $message .='<br>'.
                    ...
                    <tr>
                      <td align="center" style="font-size:14px;height:20px;background-color:#fcb800"> We would like to hear about your shopping experience with us! Please click on the link below and share your feedback as we value your opinion and they will immensely help us to improve our services. </td>
                    </tr>
                    <tr>
