          ...
          <tbody>
            <tr>
              <td height="70" align="center" valign="middle" style="background-color:#fff;padding:10px"><table style="color:#00295e;font-size:20px;width:100%">
                  <tbody>
                    <tr>
                      <td height="70" align="center" valign="middle" style="background-color: #151313;"><a href="https://localhost/project/shopurneeds" style="display:block;border:0;text-decoration:none" target="_blank" data-saferedirecturl=""> <img style="max-width:250px;"   src="https://localhost/project/shopurneeds/images/logo.png" class="CToWUd"> </a></td>
                    </tr>
                  </tbody>
                </table></td>
            </tr>
...
$totalcost=$totalcost;
 ...
 $gtotal=($totalcost + $shipprice+$tax1);
                      ...
                      <td width="100%" align="left" valign="top" style="padding:0 10px"><table width="100%" align="right" cellpadding="5" cellspacing="0" border="0">
                          ...
                          <td style="font-weight:600;font-size:15px;color:#002b4f;height:20px;background-color:#f7cfbe;border:1px solid #f7cfbe" valign="middle">Payment Method:</td>
                              ...
                              <td align="left" valign="top"><table cellpadding="5" width="100%" style="border:1px solid #f7cfbe" cellspacing="0">
                                  <tbody>
                                    <tr valign="top" style="min-height:90px">
                                      <td style="font-weight:600;font-size:15px;color:#002b4f;height:20px;border:1px solid #f7cfbe;text-align:center" valign="middle">Online</td>
                                    </tr>
                                  </tbody>
                                </table></td>
                            </tr>
    ...
    $billcountry2 = mysqli_fetch_assoc(mysqli_query($conn,"select countryname from ".$sufix."country where countrycode='".$rowuser['deliver_country']."'"));  $billcountry2['countryname']; $message .='<br>'.
                    ...
                    <tr>
                      <th align="center" style="font-size:17px;background-color:#f7cfbe">Happy Shopping @ https://localhost/project/shopurneeds</th>
                    </tr>
                    <tr>
