        ...
        <div class="sidenav h-100 modal-dialog bg-light">
            ...
            <div class="navbar">
                ...
                <a href="index.html" class="navbar-brand">
                    ...
                    <!-- <img src="assets/img/logo.png" alt="..."> --><span class="hidden-folded d-inline l-s-n-1x">Basik</span> </a>
                <!-- / brand -->
            </div>
            <!-- Flex nav content -->
                ...
                <div class="nav-active-text-primary" data-nav>
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="#" class=""><span class="nav-icon"><i data-feather="pie-chart"></i></span> <span class="nav-text">Charts</span> <span class="nav-caret"></span></a>
                            <ul class="nav-sub nav-mega">
                                <li><a href="chart.apex.html" class=""><span class="nav-text">Apexchart</span></a></li>
        ...
        <div id="header" class="page-header">
            <div class="navbar navbar-expand-lg">
                ...
                <ul class="nav navbar-menu order-1 order-lg-2">
                            ...
                            <div class="scrollable hover" style="max-height: 250px">
                                <div class="list list-row">
                                    <div class="list-item" data-id="15">
                                        <div><a href="#"><span class="w-32 avatar gd-success">J</span></a></div>
                                        <div class="flex">
                                    ...
                                    <div class="list-item" data-id="17">
                                        <div><a href="#"><span class="w-32 avatar gd-warning">H</span></a></div>
                                        <div class="flex">
                                    ...
                                    <div class="list-item" data-id="4">
                                        <div><a href="#"><span class="w-32 avatar gd-success"><img src="assets/img/a4.jpg" alt="."></span></a></div>
                                        <div class="flex">
                                    ...
                                    <div class="list-item" data-id="7">
                                        <div><a href="#"><span class="w-32 avatar gd-primary"><img src="assets/img/a7.jpg" alt="."></span></a></div>
                                        <div class="flex">
                                    ...
                                    <div class="list-item" data-id="2">
                                        <div><a href="#"><span class="w-32 avatar gd-primary"><img src="assets/img/a2.jpg" alt="."></span></a></div>
                                        <div class="flex">
                                            <div class="item-feed h-2x">Can data lead us to making the best possible decisions?</div>
                                        </div>
                                    </div>
                                    <div class="list-item" data-id="1">
                                        <div><a href="#"><span class="w-32 avatar gd-primary"><img src="assets/img/a1.jpg" alt="."></span></a></div>
                                        <div class="flex">
                    ...
                    <!-- User dropdown menu -->
                    <li class="nav-item dropdown"><a href="#" data-toggle="dropdown" class="nav-link d-flex align-items-center px-2 text-color"><span class="avatar w-24" style="margin: -2px"><img src="assets/img/a2.jpg" alt="..."></span></a>
            ...
            <div>
                <div class="page-hero page-container" id="page-hero">
                    <div class="padding d-flex">
                        <div class="page-title">
                            <h2 class="text-md text-highlight">ADD STAFF</h2><small class="text-muted">Add Product details, pricing, Variants and images</small></div>
                        <div class="flex"></div>
                        <div><a href="#" class="btn btn-md text-muted"><span class="d-none d-sm-inline mx-1">View All Products</span> <i data-feather="arrow-right"></i></a></div>
                    </div>
                </div>
                <div class="page-content page-container" id="page-content">
                  <div class="padding">
                            ...
                            <div class="col-md-12">
                             ...
                             <div class="card">
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            <div class="input-group-prepend"><span class="input-group-text" id="">First Name</span></div>
                                            <input type="text" class="form-control" placeholder="Write here">
                                            </div>
                                    </div>
                                      <div class="col-md-4">
                                            <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text" id="">Last name</span></div>
                                            <input type="text" class="form-control" placeholder="Write here">
                                            </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                            <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text" id="">Phone</span></div>
                                            <input type="number" class="form-control" placeholder="Write here">
                                            </div>
                                    </div>
                                    <div class="col-md-4">
                                            <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text" id="">Mobile</span></div>
                                            <input type="number" class="form-control" placeholder="Write here">
                                            </div>
                                    </div>
                            ...
                            <div class="input-group mb-3"><div class="input-group-prepend"><label class="input-group-text" for="inputGroupSelect01">Gender</label></div><select class="custom-select" id="inputGroupSelect01"><option selected="selected">Choose...</option>
                     ...
                     <div class="padding">
                            ...
                            <div class="input-group mb-3"><div class="input-group-prepend"><label class="input-group-text" for="inputGroupSelect01">Select Department </label></div><select class="custom-select" id="inputGroupSelect01"><option selected="selected">Choose...</option>
                            ...
                            <div class="input-group mb-3"><div class="input-group-prepend"><label class="input-group-text" for="inputGroupSelect01">Select Designation</label></div><select class="custom-select" id="inputGroupSelect01"><option selected="selected">Choose...</option>
                            ...
                            <div class="input-group mb-3"><div class="input-group-prepend"><label class="input-group-text" for="inputGroupSelect01">Reporting Boss</label></div><select class="custom-select" id="inputGroupSelect01"><option selected="selected">Choose...</option>
                                                <option value="1">Shakti</option>
                                                <option value="2">Gajenn </option>
                            ...
                            <div class="input-group mb-3"><div class="input-group-prepend"><label class="input-group-text" for="inputGroupSelect01">Assets Allocate</label></div><select class="custom-select" id="inputGroupSelect01"><option selected="selected">Choose...</option>
                            ...
                            <div class="input-group mb-3"><div class="input-group-prepend"><label class="input-group-text" for="inputGroupSelect01">Role Access </label></div><select class="custom-select" id="inputGroupSelect01"><option selected="selected">Choose...</option>
                            ...
                            <div class="input-group mb-3"><div class="input-group-prepend"><label class="input-group-text" for="inputGroupSelect01">Date of Joining</label></div><input id="event-end-date" type="date" class="form-control" placeholder="Date"></div>
                     ...
                     <div class="padding">
                           ...
                           <div class="col-md-12">
                               <div class="card">
                                    ...
                                    <div class="col-md-4">
                                         <div class="card-header"><strong>PAN Upload</strong></div>
                                             <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text" id="">PAN-No</span></div>
                                            <input type="text" class="form-control" placeholder="Write here">
                                            </div>
                                    <div class="card-body">
                                    
                  
                                       <form action="http://flatfull.com/themes/basik/html/api/dropzone" class="dropzone white b-a b-3x b-dashed b-primary p-a rounded p-5 text-center"><div class="dz-message"><h4 class="my-4">Drop files here or click to upload.</h4><span class="text-muted d-block mb-4">(This is just a demo dropzone. Selected files are <strong>not</strong> actually uploaded.)</span></div></form>
                                       
                                    </div>
                                    </div>
                                    <div class="col-md-4">
                                         <div class="card-header"><strong>GST Upload</strong></div>

                                             <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text" id="">GST-No</span></div>
                                            <input type="text" class="form-control" placeholder="Write here">
                                            </div>
                                    <div class="card-body">
                                    ...
                                    <div class="col-md-4">
                                         <div class="card-header"><strong>Cheque Upload</strong></div>
                                             <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text" id="">Cheque-No</span></div>
                                            <input type="text" class="form-control" placeholder="Write here">
                                            </div>
                                    <div class="card-body">
                                    ...
                                    <div class="row" style="padding: 10px;">
                                         ...
                                         <div class="col-md-4">
                                            <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text" id="">Account No</span></div>
                                            <input type="text" class="form-control" placeholder="Write here">
                                            </div>
                                    </div>
                                      <div class="col-md-4">
                                            <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text" id="">Account Name</span></div>
                                            <input type="text" class="form-control" placeholder="Write here">
                                            </div>
                                    </div>
                                      <div class="col-md-4">
                                            <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text" id="">IFSC Code</span></div>
                                            <input type="text" class="form-control" placeholder="Write here">
                                            </div>
                                    </div>
                     ...
                     <div class="padding">
                            ...
                            <div class="card">
                                <div class="card-header"><strong>Permanent Address</strong></div>
                                    ...
                                    <div class="col-md-6">
                                            <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text" id="">Street Address</span></div>
                                            <input type="text" class="form-control" placeholder="Write here">
                                            </div>
                                    </div>
                                      <div class="col-md-3">
                                            <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text" id=""> State</span></div>
                                            <input type="text" class="form-control" placeholder="Write here">
                                            </div>
                                    </div>
                                     <div class="col-md-3">
                                            <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text" id="">  City</span></div>
                                            <input type="text" class="form-control" placeholder="Write here">
                                            </div>
                                    </div>
                                    <div class="col-md-6">
                                            <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text" id="">Area</span></div>
                                            <input type="text" class="form-control" placeholder="Write here">
                                            </div>
                                    </div>
                                     <div class="col-md-3">
                                            <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text" id="">  Pin</span></div>
                                            <input type="text" class="form-control" placeholder="Write here">
                                            </div>
                                    </div>
                                     <div class="col-md-3">
                              ...
                              <div class="card">
                                ...
                                <button class="btn w-sm mb-1 btn-success" style="float: right;    margin-right: 12px;">SAVE</button>
                                </div>
...
<!-- Mirrored from flatfull.com/themes/basik/html/form.element.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jan 2020 05:56:05 GMT -->
