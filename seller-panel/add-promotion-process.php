...
{ 
    ...
    mysqli_query($conn,"insert into `".$sufix."category` (`promotionId`,`categoryname`,`parent`, `cat_dept`, `adddate`,`displayflag`,`add_user`, `cat_slug`) values ('".$id."','".$name."','0','1','".date("Y-m-d")."', '1', '".$_SESSION['username']."', '".$link."')");   
}
