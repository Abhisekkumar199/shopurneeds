...
$sql_today_all_order = mysqli_num_rows(mysqli_query($conn,"select sid from ".$sufix."order_seller where   seller_id='".$_SESSION['sellerid']."' and orderdate='".$current_date."'"));
$sql_today_delivered = mysqli_num_rows(mysqli_query($conn,"select sid from ".$sufix."order_seller where seller_id='".$_SESSION['sellerid']."' and approve_status ='Delivered' and  orderdate='".$current_date."'"));
$sql_today_cancelled = mysqli_num_rows(mysqli_query($conn,"select sid from ".$sufix."order_seller where  seller_id='".$_SESSION['sellerid']."' and approve_status ='Cancelled' and  orderdate='".$current_date."'"));
$sql_total_order = mysqli_num_rows(mysqli_query($conn,"select sid from ".$sufix."order_seller where seller_id='".$_SESSION['sellerid']."'  "));
$sql_total_delivered = mysqli_num_rows(mysqli_query($conn,"select sid from ".$sufix."order_seller where seller_id='".$_SESSION['sellerid']."' and approve_status='Delivered'"));
$sql_total_cancelled = mysqli_num_rows(mysqli_query($conn,"select sid from ".$sufix."order_seller where seller_id='".$_SESSION['sellerid']."' and approve_status='Cancelled'")); 
$sql_total_sku = mysqli_num_rows(mysqli_query($conn,"select id from ".$sufix."products where seller_id='".$_SESSION['sellerid']."' and vartype=''"));  

$all_order_amt = mysqli_fetch_assoc(mysqli_query($conn,"select sum(totalcost) as totalcost  from ".$sufix."order_seller  where 1=1 and seller_id='".$_SESSION['sellerid']."'   ")); 
$all_cancelled_amt = mysqli_fetch_assoc(mysqli_query($conn,"select sum(totalcost) as totalcost from ".$sufix."order_seller where approve_status='Cancelled' and seller_id='".$_SESSION['sellerid']."' "));
$all_delivered_amt = mysqli_fetch_assoc(mysqli_query($conn,"select sum(totalcost) as totalcost from ".$sufix."order_seller where approve_status='Delivered' and seller_id='".$_SESSION['sellerid']."' "));
