        ...
        <div>
            ...
            <div class="page-hero page-container" id="page-hero">
                <div class="padding d-flex">
                    ...
                    <div class="flex"></div>
                    <div><a href="<?php echo URL ?>/admin-panel/add-promotion" class="btn w-sm mb-1 btn-primary" style="width: 135px;"> הוסף מבצעים </a></div>
                </div>
            </div>
                            ...
                            <table class="table table-theme table-row v-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-muted"> שם קידום  </th>  
                                        ...
                                        <td>
                                            <div class="item-action dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right bg-black" role="menu"> 
                                                    <?php if($row['displayflag']==1) { ?>
													    <a class="dropdown-item edit" href="enable_disable_process.php?id=<?php echo $row['id']; ?>&page=<?php echo $page; ?>&status=0&link=promotion-list&tb=<?php echo $sufix; ?>promotion&option=id">השבת</a> 
													<?php } elseif($row['displayflag']==0) { ?>												
														<a class="dropdown-item edit" href="enable_disable_process.php?id=<?php echo $row['id']; ?>&page=<?php echo $page; ?>&status=1&link=promotion-list&tb=<?php echo $sufix; ?>promotion&option=id">לאפשר</a>
													<?php } ?>
													<a class="dropdown-item edit" href="delete-process.php?id=<?php echo $row['id']; ?>&page=<?php echo $page; ?>&link=promotion-list&tb=<?php echo $sufix; ?>promotion&option=id" onclick="return confirm('Are you sure to delete this?')" >למחוק</a> 
													<a class="dropdown-item edit" href="add-promotion?option=Edit&id=<?php echo $row['id']; ?>&page=<?php echo $page; ?>">ערוך</a> 
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <div class="page-content page-container" id="page-content">
                <div class="padding">
                    <div class="mb-5">
                                        ...
                                        <td>
                                            <div class="item-action dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right bg-black" role="menu"> 
													...
													<a class="dropdown-item edit" href="join-promotion?id=<?php echo $row['id']; ?>">Join</a>  	 
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div class="d-flex"> 
                            <?php pagingall($offset,$num,'seller-promotions.php',$page,$no_page,$display_range); ?>
