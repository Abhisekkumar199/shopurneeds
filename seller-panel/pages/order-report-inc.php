...
if($_REQUEST['search_text']!='' || $_REQUEST['sellerid']!=''  || $_REQUEST['brandid']!='' || $_REQUEST['start_date']!='' || $_REQUEST['end_date']!='')
{
	...
	$sql .=" where oid!='' and seller_id='".$_SESSION['sellerid']."'"; 	
}
else
{
	$sql .=" where oid!='' and seller_id='".$_SESSION['sellerid']."'";	
                ...
                <div class="page-content page-container" id="page-content">
                    <div class="padding">
                        <div class="mb-5 web">
                            ...
                            <form name="esdere" action="report_order.php" method="post">
                                 ...
                                 <table class="table table-theme table-row v-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="v-middle" data-id="15"> 
                                            ...
                                            <td class="flex"><a href="#" class="item-title text-color"><?php echo $row['deliver_fname']." ".$row['deliver_lname']; ?></a>
                                                <div class="item-title text-color"><?php echo $row['deliver_phone']; ?></div>
                                                <div class="item-title text-color"><?php echo $row['deliver_address']; ?></div>
                                                <div class="item-title text-color"><?php echo $row['deliver_city']; ?>-<?php echo $row['deliver_zip']; ?></div>
                                            </td>
                                            <td class="flex">
