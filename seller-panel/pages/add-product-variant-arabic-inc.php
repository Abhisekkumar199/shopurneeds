...
<span class="sizecharthtml" style="display:none;"> 
    ...
    <span class="input-group-text">Sale JD</span><input type="text" name="sale_price[]" placeholder="" class="form-control sale_price">&nbsp;&nbsp;
...
<div class="page-hero page-container" id="page-hero">
    <div class="padding d-flex">
        <div class="page-title">
            <h2 class="text-md text-highlight">إضافة منتج مختلف</h2> </div>
        <div class="flex"></div> 
    </div>
</div>
    ...
    <div class="padding"> 
        <div class="card">
            ...
            <div class="row" id="show_sub_categories">
                <div class="col-md-3">
                    <div class="card-header"><strong>إختر لون</strong></div> 
                    <div class="card-body" > 
                        <div class="input-group mb-3"> 
                            <select class="custom-select" onchange="variant(this.value);" id="color" name="color"  >
                                <option value="">تحديد</option>
                                <?php
                                $sql_variant = "select * from shopurneeds_color_code order by name asc";
