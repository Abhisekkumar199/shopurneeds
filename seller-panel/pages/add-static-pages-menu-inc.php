                    ...
                    <div class="col-md-12"> 
                        <div class="card"> 
                            <div class="card-body"> 
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Title in Arabic</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="itemname_in_arabic" id="itemname_in_arabic" value="<?php echo $rows['itemname_in_arabic']; ?>" class="form-control" placeholder="Title in Arabic">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Description in Arabic</label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="description_in_arabic" id="description_in_arabic" rows="4"><?php echo $rows['description_in_arabic']; ?></textarea>
                                    </div>
                                </div> 
                                <div class="form-group row">
