        ...
        <div class="page-hero page-container" id="page-hero">
            <div class="padding d-flex">
                <div class="page-title">
                    <h2 class="text-md text-highlight"><?php if($_SESSION['admin_language'] == 'HE') { ?>הוסף משתמש<?php } else { ?>Add User <?php } ?></h2>
                </div>
                <div class="flex"></div>
                <div><a href="seller-list" class="btn btn-md text-muted"><span class="d-none d-sm-inline mx-1"><?php if($_SESSION['admin_language'] == 'HE') { ?>רשימת משתמש<?php } else { ?> User List<?php } ?></span> <i data-feather="arrow-right"></i></a></div>
            </div>
        </div>
