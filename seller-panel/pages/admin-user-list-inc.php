    ...
    <div id="content" class="flex">
        ...
        <div>
            ...
            <div class="page-hero page-container" id="page-hero">
                <div class="padding d-flex">
                    <div class="page-title">
                        <h2 class="text-md text-highlight">צפו בכל המשתמשים</h2></div> 
                    <div class="flex"></div>
                    <div><a href="add-admin-user" class="btn w-sm mb-1 btn-primary">הוסף משתמש</a></div>
                </div>
            </div>
            <div class="page-content page-container" id="page-content">
                <div class="padding">
                    <div class="mb-5">
                            ...
                            <table class="table table-theme table-row v-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-muted">שם משתמש</th> 
                                ...
                                <tbody>
                                    ...
                                    <tr class="v-middle" data-id="15">
                                        ...
                                        <td class="flex"><?php echo $row['username'];	?></td>  
                                        <td class="flex"><?php echo $row['email'];	?></td>
                                        ...
                                        <td>
                                            <div class="item-action dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right bg-black" role="menu"> 
                                                    <?php if($row['displayflag']==1) { ?>
													    <a class="dropdown-item edit" href="enable_disable_process.php?id=<?php echo $row['id']; ?>&page=<?php echo $page; ?>&status=0&link=admin-user-list.php&tb=<?php echo $sufix; ?>admin&option=id">השבת</a> 
													<?php } elseif($row['displayflag']==0) { ?>												
														<a class="dropdown-item edit" href="enable_disable_process.php?id=<?php echo $row['id']; ?>&page=<?php echo $page; ?>&status=1&link=admin-user-list.php&tb=<?php echo $sufix; ?>admin&option=id">אפשר</a>
													<?php } ?>
													<a class="dropdown-item edit" href="delete-process.php?id=<?php echo $row['id']; ?>&page=<?php echo $page; ?>&link=admin-user-list.php&tb=<?php echo $sufix; ?>admin&option=id" onclick="return confirm('Are you sure to delete this?')" >מחק</a>
                        ...
                        <div class="d-flex"> 
                            <?php pagingall($offset,$num,'admin-user-list.php',$page,$no_page,$display_range); ?>
            ...
            <div class="page-hero page-container" id="page-hero">
                <div class="padding d-flex">
                    <div class="page-title">
                        <h2 class="text-md text-highlight">VIEW ALL USER</h2></div> 
                    <div class="flex"></div>
                    <div><a href="add-admin-user" class="btn w-sm mb-1 btn-primary">Add User</a></div>
                </div>
            </div>
            <div class="page-content page-container" id="page-content">
                <div class="padding">
                                    ...
                                    <tr class="v-middle" data-id="15">
                                        ...
                                        <td>
                                            <div class="item-action dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right bg-black" role="menu"> 
                                                    <?php if($row['displayflag']==1) { ?>
													    <a class="dropdown-item edit" href="enable_disable_process.php?id=<?php echo $row['id']; ?>&page=<?php echo $page; ?>&status=0&link=admin-user-list.php&tb=<?php echo $sufix; ?>admin&option=id">Disable</a> 
													<?php } elseif($row['displayflag']==0) { ?>												
														<a class="dropdown-item edit" href="enable_disable_process.php?id=<?php echo $row['id']; ?>&page=<?php echo $page; ?>&status=1&link=admin-user-list.php&tb=<?php echo $sufix; ?>admin&option=id">Enable</a>
													<?php } ?>
													<a class="dropdown-item edit" href="delete-process.php?id=<?php echo $row['id']; ?>&page=<?php echo $page; ?>&link=admin-user-list.php&tb=<?php echo $sufix; ?>admin&option=id" onclick="return confirm('Are you sure to delete this?')" >Delete</a>
