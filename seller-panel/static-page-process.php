...
$heading_in_hebrew=$_REQUEST['heading_in_hebrew'];
$description_in_hebrew=$_REQUEST['description_in_hebrew'];
...
{	
    ...
    mysqli_query($conn,"update `".$sufix."static_pages` set `heading`='".$heading."',`menuposition`='".$menuposition."',`link_name`='".$slug."', `imageupload`='".$fieldname."',`add_user`='".$_SESSION['username']."',`description`='".mysqli_real_escape_string($conn,$description)."',`metatitle`='".mysqli_real_escape_string($conn,$metatitle)."',`metakeyword`='".mysqli_real_escape_string($conn,$metakeyword)."',`metadescription`='".mysqli_real_escape_string($conn,$metadescription)."',`heading_in_hebrew`='".$heading_in_hebrew."',`description_in_hebrew`='".$description_in_hebrew."',`metatitle_in_hebrew`='".$metatitle_in_hebrew."',`metakeyword_in_hebrew`='".$metakeyword_in_hebrew."',`metadescription_in_hebrew`='".$metadescription_in_hebrew."', `displayflag`='".$status."', `editdate`='".date("Y-m-d")."'   where id='".$id."'") ;  
}
else
{  
