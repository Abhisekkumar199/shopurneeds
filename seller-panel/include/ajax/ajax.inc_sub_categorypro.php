...
<select name="subcatid" class="inputmenu" onchange="getsubcategory(this.value)">

	<option value="">--Select Sub-Category--</option>

	<?php
//echo "SELECT * FROM shopurneeds_category WHERE parent = '".$_GET["catid"]."' and cat_type='category'";
	mysqli_query($conn,"SELECT * FROM shopurneeds_category WHERE parent = '".$_GET["catid"]."' and cat_type='category'") ;
