                ...
                <div class="page-hero page-container" id="page-hero">
                    <div class="padding d-flex">
                        <div class="page-title">
                            <h2 class="text-md text-highlight">ATTRIBUTE & FILTERS</h2><small class="text-muted">Add Product details, pricing, Variants and images</small></div>
                        <div class="flex"></div>
                        ...
                        <div class="card" style="padding: 10PX;">
                                 ...
                                 <div class="col-md-6">
                                           ...
                                           <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text" id="">Filter Name</span></div>
                                ...
                                <div class="col-md-6">
                                   ...
                                   <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text" id=""> Display Name</span></div>
                                            <input type="text" class="form-control" placeholder="Write here">
                                            </div>
                                ...
                                <div class="col-md-6">
                                   ...
                                   <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text" id="">    Filter Values</span></div>
                                            <input type="text" class="form-control" placeholder="Write here">
                                            </div>
                                ...
                                <div class="mt-2" id="event-type">
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="type" value="Appointment"> Mandatory</label></div>
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="radio" name="type" value="Meeting"> Non Mandatory</label>
                                                </div>
                                            </div>
                                        </div>
