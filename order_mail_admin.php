...
<body>
<table width="700" oooooooooooooooooooo admin align="center" cellpadding="0" cellspacing="0" style="font-size:13px;font-family:arial,sans-serif;color:#00295e;background:#f7f7f7;padding:0px">
  <tbody>
    <tr>
          ...
          <tbody>
            ...
            <tr>
              <td align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="15" cellspacing="0">
                  <tbody>
                    <tr>
                <td width="60%" align="left" valign="top" style="color:#002b4f; "> Dear Admin, <br>
                        A new order with order no. '.$orderid.' is successfully booked. </td>
            ...
            <tr>
              <td><table width="100%" border="0" align="center" cellpadding="15" cellspacing="0">
                  <tbody>
                    <tr>
                      <td style="padding:5px 15px;font-size:13px;color:#00295e;line-height:17px"> 
                        Item details are given below: </td>
                    </tr>
                    <tr>
