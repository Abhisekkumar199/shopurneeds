...
if($userchec==0)
{
		if ($product != false) {
			...
			{
			    $sqlporr=mysql_fetch_array(mysql_query("select product_sellingprice from `shopurneeds_product_size` where product_id='".$productId."' and product_size='".$size."'"));
