            ...
            <div>
                <div class="page-hero page-container" id="page-hero">
                    <div class="padding d-flex">
                        <div class="page-title">
                            <h2 class="text-md text-highlight">ADD PAGE</h2><small class="text-muted">Add Product details, pricing, Variants and images</small></div>
                        <div class="flex"></div>
                ...
                <div class="page-content page-container" id="page-content">
                  <div class="padding">
                            ...
                            <div class="col-md-12">
                             ...
                             <div class="card">
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            <div class="input-group-prepend"><span class="input-group-text" id="">Page Name</span></div>
                                            <input type="text" class="form-control" placeholder="Write here">
                                            </div>
                                    </div>
                                    <div class="col-md-6">
                                            <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text" id="">Page Slug</span></div>
                                            <input type="text" class="form-control" placeholder="Write here">
                                            </div>
                                    </div>
                            ...
                            <div class="input-group mb-3"><div class="input-group-prepend"><label class="input-group-text" for="inputGroupSelect01">Select Page </label></div><select class="custom-select" id="inputGroupSelect01"><option selected="selected">Choose...</option>
                                                <option value="1">Page1</option>
                                                <option value="2"> Page1 </option>
                                                
                                            </select>
                                             <input type="text" class="form-control" placeholder="Menu Link">
                                        </div>
                     ...
                     <div class="padding">
                           ...
                           <div class="col-md-12">
                               <div class="card">
                                    ...
                                    <div class="col-md-12">
                                         <div class="card-header"><strong>Page Banner</strong></div>
                     ...
                     <div class="padding">
                            ...
                            <div class="col-md-12">
                            <div class="card">
                                <div class="card-header"><strong>Page Editor Description </strong></div>
                                    ...
                                    <div class="col-md-12">
                                           <textarea class="form-control" rows="7" placeholder="Page Editor Description"></textarea>
                                    </div>
