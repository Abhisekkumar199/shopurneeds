                                ...
                                <tbody>
                                    ...
                                    <tr class="v-middle" data-id="15">
                                        ...
                                        <td class="flex">
                                            ...
                                            <?php } else { ?>
                                                <img src="<?php echo URL ?>/assets/images/default.png" width="50"  /> 
                                            <?php } ?>
                                        </td>
                                        ...
                                        <td>
                                            <div class="item-action dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right bg-black" role="menu"> 
													...
													<a class="dropdown-item edit" href="<?php echo URL;?>/process/seller_email_login.php?emailid=<?php echo $row['emailid'];?>" target="_blank">Seller Login</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
