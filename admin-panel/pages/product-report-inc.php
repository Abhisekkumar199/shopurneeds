...
if($_REQUEST['search_text']!='' || $_REQUEST['category']!='' || $_REQUEST['sdate']!='' || $_REQUEST['pricerange']!='' || $_REQUEST['edate']!='' || $_REQUEST['brandid']!='' || $_REQUEST['sellerid']!='' || $_REQUEST['sub_category']!='')
{
                                        ...
                                        <tr class="v-middle" data-id="15">
                                            ...
                                            <td>
                                                <div class="avatar-group web-1">
                                                    ...
                                                    <?php } ?>
                                                     <a href="<?php echo URL; ?>/admin-panel/product-image.php?id=<?php echo $row['id']; ?>"><span class="web-2">+ <?php echo $total_image; ?> Images</span></a>
                                                </div>
                                            </td>
