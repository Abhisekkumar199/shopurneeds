        ...
        <div class="page-hero page-container" id="page-hero">
            <div class="padding d-flex">
                <div class="page-title">
                    ...
                    <h2 class="text-md text-highlight">Upload Product Images</h2>
                </div>
                <div class="flex"></div>
                <div><a href="product-list" class="btn btn-md text-muted"><span class="d-none d-sm-inline mx-1">Product List</span> <i data-feather="arrow-right"></i></a></div>
            </div>
        </div>
                        ...
                        <div class="card"> 
                            <div class="card-body"> 
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-12 col-form-label"><h5>Product : - <?php echo $row_product['productname']; ?></h5></label> 
                    ...
                    <div class="col-sm-3">
                        <div class="card rt-20">
                            <div class="media web-30 text-center">
                                    ...
                                    <img src="../uploads/productimage/thumb/<?php echo $image_name; ?>" alt="..." style="    padding-top: 35px;height: 300px;width:100%;margin-left: -9px;"> 
