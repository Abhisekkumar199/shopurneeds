...
<div class="page-hero page-container" id="page-hero">
    <div class="padding d-flex">
        <div class="page-title">
            <h2 class="text-md text-highlight">EDIT PRODUCT</h2><small class="text-muted">Add Product details, pricing, Variants and images</small></div>
        <div class="flex"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6"> 
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="gst" id="gst" value="<?php echo $sql_product['gst']; ?>" placeholder="Ex: 2345672890">
                                </div>  
                            </div> 
                            <div class="col-md-6">
                                <div class="input-group mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend"><label class="input-group-text" for="inputGroupSelect01">Select Seller</label></div>
                                    <select class="custom-select" name="seller_id" id="seller_id">
                                        <option value="">Select</option>
                                        <?php  
        				                $sqlvendor  = mysqli_query($conn,"select id,suppliername from ".$sufix."suppliers where displayflag='1' order by suppliername ASC") ;
        				                while($rows_sellar= mysqli_fetch_assoc($sqlvendor))
                						{																				
                						?>
                						<option value="<?php echo $rows_sellar['id']; ?>" <?php if($rows_sellar['id']==$sql_product['seller_id']) { ?> selected<?php } ?>><?php echo $rows_sellar['suppliername']; ?></option>	
                						<?php } ?>	
                                    </select>
                                </div>
