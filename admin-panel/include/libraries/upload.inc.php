...
class upload{
	...
	function upload ( $file_perm , $max_fil = 1000000, $arc_dir = ".." ){
		if ( empty ($file_perm) )
			$file_perm = array ("application/msword", "image/pjpeg", "image/bmp"
,"image/x-png","image/jpeg","image/png","image/gif","application/x-zip-compressed","application/pdf","application/vnd.ms-powerpoint","video/quicktime","video/x-ms-wmv","audio/mpeg", "image/jpg");
	...
	function putFile ( $file )
	{
        ...
        if ( $error == "" )
        {
			...
			//COMMENT FOR REPLACING THE IMAGE IN CASE OF IMAGE ALREADY UPLOADED BY THE SAME NAME
	...
	function resize_jpeg( $image_file_path, $new_image_file_path, $max_width=480, $max_height=1600 )
	{
		...
		/*if(eregi("\.(gif)$",$image_file_path)) // if is a jpg
    	{
...
//////////////////////Prabhash
	...
	/*	echo "file:".$img;
		...
		$FullImage_width = $imagesize[0];    // original width
		$FullImage_height = $imagesize[1]; */
//////////////////////
	...
	function miniatura ( $image_path, $path, $larghezza=65, $altezza=55, $pre_name="thumb_" )
	{
        ...
        elseif ($image_path) return "Impossibile to Create Thumbnail from this File.<BR>";
