...
{	
    ...
    mysqli_query($conn,"update `".$sufix."banners` set `bannername`='".$bannername."',`externallink`='".$externallink."',`description`='".$description."', `uploadimage`='".$fieldname."',`bposition`='".$bposition."',`add_user`='".$_SESSION['username']."', `displayflag`='".$status."', `editdate`='".date("Y-m-d")."'   where id='".$id."'") ;
    
     
}
else
{  
    mysqli_query($conn,"insert into `".$sufix."banners` set `bannername`='".$bannername."',`externallink`='".$externallink."',`description`='".$description."', `uploadimage`='".$fieldname."',`bposition`='".$bposition."',`add_user`='".$_SESSION['username']."', `displayflag`='".$status."', `adddate`='".date("Y-m-d")."'") ; 
