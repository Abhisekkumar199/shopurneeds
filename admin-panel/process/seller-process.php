...
{	
    ...
    mysqli_query($conn,"update `".$sufix."suppliers` set `suppliername`='".$suppliername."',`seller_slug`='".$slug."',`emailid`='".$emailid."',phone='".$phone."', `brandname`='".$brandname."',`address1`='".$address1."',`address2`='".$address2."',`pcity`='".$pcity."',`metatitle`='".mysqli_real_escape_string($conn,$metatitle)."',`metakeyword`='".mysqli_real_escape_string($conn,$metakeyword)."',`metadescription`='".mysqli_real_escape_string($conn,$metadescription)."',`uploadimage`='".$fieldname."', `displayflag`='".$status."', `editdate`='".date("Y-m-d")."'   where id='".$id."'") ;
    
}
else
{  
    mysqli_query($conn,"insert into `".$sufix."suppliers` set  `suppliername`='".$suppliername."',`seller_slug`='".$slug."',`emailid`='".$emailid."',phone='".$phone."',`brandname`='".$brandname."',`address1`='".$address1."',`address2`='".$address2."',`pcity`='".$pcity."',`metatitle`='".mysqli_real_escape_string($conn,$metatitle)."',`metakeyword`='".mysqli_real_escape_string($conn,$metakeyword)."',`metadescription`='".mysqli_real_escape_string($conn,$metadescription)."',`add_user`='".$_SESSION['username']."', `displayflag`='".$status."', `adddate`='".date("Y-m-d")."'") ; 
