                                ...
                                <tbody>
                                    ...
                                    ?>   
                                        <tr>
                                            ...
                                            <td style="width: 240px;" class="text-left product-name"><a href="<?php echo $rowcs['slug']; ?>"><?php echo $rowcs['productname']; ?></a> <span class="text-left price"><?php echo $rowcs['quantity']; ?> x <?php echo Currency.$totalamount; ?></span>
