...
<head> 
    ...
    <script>  
        $(document).ready(function(){ 
        	...
        	$.ajax({
            	url : "https://localhost/project/shopurneeds/set-current-datetime.php",
            	type : "POST",
            	data : data,
              ...
              <div class="row align-items-center">
                ...
                <div class="col-md-6">
                  <ul class="header-top-right pull-right">
                    ...
                    <li class="login" >
                      <a href="<?php echo URL; ?>/logout" class="ng-binding">Logout</a> 
                    </li>
                    <?php } ?>
                    ...
                    <div class="header-link-search">
                        ...
                        <div class="header-link">
                         <ul class="list-unstyled"> 
                            <?php    
                            $sql_deal=mysqli_query($conn,"select * from `".$sufix."deal` where display_flag='1' ");
                            $num1=mysqli_num_rows($sql_deal); 
                            if($num1 > 0)
                            { 
                                $j = 0;
                            while($rowsdeal=mysqli_fetch_assoc($sql_deal))
                            {
                            ?>  
                                <li style="background:url(https://localhost/project/shopurneeds/uploads/bannerimages/35_discount-g.png) no-repeat 0 4px;"><a href="<?php echo URL; ?>/deals?str=<?php echo $rowsdeal['id']; ?>"><?php echo $rowsdeal['name']; ?></a></li>  
                            <?php $j++;  } } ?>  
                        </ul>
                        </div>
                    </div>
                    <div class="shopcart showcartvalue"> 
                        <div id="cart" class="btn-block mt-40 mb-30 ">
                            <button type="button" class="btn" data-target="#cart-dropdown" data-toggle="collapse" aria-expanded="true">
                              ...
                              <span id="cart-total">Item <?php if(isset($_SESSION['shopid'])) { echo $sqlcd=mysqli_num_rows(mysqli_query($conn,"select * from ".$sufix."basket where bid='".$_SESSION['shopid']."'")); } ?></span>
                            </button>
            ...
            <div class="container">
              <div class="row">
                <div class="icon-block">
                  ...
                  <?php if(@$_SESSION['emailid']=='') { ?>
                    <div class="login_icon"><a   href="javascript:void(0);"  data-toggle="modal" data-target="#loginModal" ><i class="fa fa-user"></i> LOGIN</a></div> 
                    <?php } else { ?>
                    <div class="login_icon">
                      <a href="<?php echo URL; ?>/mydashboard" class="ng-binding"><i class="fa fa-user"></i> Hi, <?php //echo $_SESSION['fnamenew']; ?> </a> 
                    </div>
                    <!--div class="login_icon">
                      <a href="<?php echo URL; ?>/logout" class="ng-binding"> <i class="fa fa-user"></i> Logout</a> 
                    </div-->
                    <?php } ?>  
                </div>
              </div>
