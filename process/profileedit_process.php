...
{ 
    ...
    $sql_user_address=mysqli_query($conn,"insert into ".$sufix."customer_address set user_id='$user_id',addresstype='$addredd_type',fname='$fname',lname='$lname',mobileno='$mobile',address='$address',city='$city',zipcode='$pincode',country='$countryname'"); 
}
  
?> 
    <script>window.location.href='<?php echo URL;?>/user-address';</script>
<?php 
