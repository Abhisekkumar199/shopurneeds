...
$sqlcutrsssa=mysqli_query($conn,"select * from shopurneeds_currency where currencycode='INR'");
...
{
$sqlcutrsssaus=mysqli_query($conn,"select * from shopurneeds_currency where currencycode='INR'");
