...
include("sql.php");
$salpr=mysqli_query($conn,"select * from shopurneeds_product where image4!='' limit 1");
while($rowss=mysqli_fetch_array($salpr))
{
$sqljjj=mysqli_query($conn,"update shopurneeds_product set displayflag='1',image4='' where id='".$rowss['id']."'");
echo $fname=str_replace(" ","%20",$rowss['image4']);
...
$sqljjj=mysqli_query($conn,"insert into shopurneeds_imageupload(pid,productimage,adddate,mainimage,sortid) values ('".$rowss['id']."','".$name12."',NOW(),'0','4')");
...
<!--
//window.location = "https://www.buydebest.com/urlimage4.php"
//-->
</script>