...
include("sql.php");
$salpr=mysqli_query($conn,"select * from shopurneeds_product where image5!='' limit 1");
while($rowss=mysqli_fetch_array($salpr))
{
$sqljjj=mysqli_query($conn,"update shopurneeds_product set displayflag='1',image5='' where id='".$rowss['id']."'");
echo $fname=str_replace(" ","%20",$rowss['image5']);
...
$sqljjj=mysqli_query($conn,"insert into shopurneeds_imageupload(pid,productimage,adddate,mainimage,sortid) values ('".$rowss['id']."','".$name12."',NOW(),'0','5')");
...
<!--
//window.location = "https://www.buydebest.com/urlimage5.php"
//-->
</script>