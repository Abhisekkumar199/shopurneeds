...
include("sql.php");
$salpr=mysqli_query($conn,"select * from shopurneeds_product where image1!='' and vartype='' order by id asc limit 1 ");
...
window.location = "https://localhost/project/shopurneeds/urlimage1.php"
