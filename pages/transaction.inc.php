            ...
            <div class="row">
                ...
                <aside class="col-lg-3 sidebar">
                        ...
                        <div class="widget admin-widget">
                            ...
                            <a href="transactions.html#" class="btn btn-default btn-center"><span>Refer A friend</span></a>
                        </div>
                        ...
                        <div class="widget admin-widget">
                            ...
                            <a href="transactions.html#" class="btn btn-default btn-center"><span>Start Chat</span></a>
                        </div>
                ...
                <!-- Container Panel  -->
                <div class="col-lg-9">
                    <h2 class="admin-heading bg-offwhite">All History</h2>

                    <!-- Filter -->
                    <div class="row">
                        <!-- Category Filter  -->
                        <div class="col-12 all-fillters-area main-form">
                            <ul class="bill-items nav nav-tabs" id="teleporter">
                                <li class="nav-item active" data-filter-value="01">Mobile</li>
                                <li class="nav-item" data-filter-value="02">DTH</li>
                                <li class="nav-item" data-filter-value="03">Datacard</li>
                                <li class="nav-item" data-filter-value="04">Landline</li>
                                <li class="nav-item" data-filter-value="05">Broadband</li>
                                <li class="nav-item" data-filter-value="06">Electricity</li>
                                <li class="nav-item" data-filter-value="07">Gas</li>
                                <li class="nav-item" data-filter-value="08">Metro</li>
                                <li class="nav-item" data-filter-value="09">Water</li>
                            ...
                            <ul class="morebtn">
                                <li>
                                    <a href="transactions.html#" class="nav-link mbtn"><i class="fas fa-ellipsis-v"></i></a>
                                    <ul class="dropdown-menu" id="receiver">
        
                                    <li class="nav-item" data-filter-value="10">G Play</li><li class="nav-item" data-filter-value="11">Cable</li><li class="nav-item" data-filter-value="12">Muncipality</li><li class="nav-item" data-filter-value="13">EMI</li><li class="nav-item" data-filter-value="14">Challan</li><li class="nav-item" data-filter-value="15">Housing</li></ul>
                                </li>
                            </ul>                                       
                        </div>
                        <!-- Category Filter End -->
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group filter-area">
                                            ...
                                            <input id="custom-date" type="text" class="form-control py-4" placeholder="Date Range">
                                            <div class="export-area" data-toggle="collapse">
                                                <div class="dropdown filter-btn">
                                                    <a class=" btn-link ml-2" href="transactions.html#"><i class="far fa-file-excel"></i></a>
                                                    <a class=" btn-link ml-2" href="transactions.html#"> <i class="far fa-file-pdf"></i></a>
                                                    <a class=" btn-link ml-2" href="transactions.html#"><i class="fas fa-print"></i></a>
                    ...
                    <div class="profile-content">
                        ...
                        <ul class="pagination justify-content-left mt-4 pt-4 pl-0">
                            <li class="page-item disabled"><a class="page-link" href="transactions.html#" tabindex="-1"><i class="fas fa-angle-left"></i></a></li>
                            <li class="page-item"><a class="page-link" href="transactions.html#">1</a></li>
                            <li class="page-item active"><a class="page-link" href="transactions.html#">2 <span class="sr-only">(current)</span></a></li>
                            <li class="page-item"><a class="page-link" href="transactions.html#">3</a></li>
                            <li class="page-item d-flex align-content-center text-muted mr-2">...</li>
                            <li class="page-item"><a class="page-link" href="transactions.html#">19</a></li>
                            <li class="page-item"><a class="page-link" href="transactions.html#"><i class="fas fa-angle-right"></i></a>
                            </li>
                        </ul>
                        <!-- Paginations end -->
