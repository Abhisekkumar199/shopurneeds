...
{ 
    ...
    $sqlprcheck=mysqli_query($conn,"select * from ".$sufix."category where parent='".$cat_id."'");
    $totalnum=mysqli_num_rows($sqlprcheck); 
...
$sql_pro="select * from ".$sufix."product where displayflag='1' and vartype='' and  seller_id='".$seller_id."' {$brand} {$color_filter} {$attribute_filter}  {$minprss1} {$maxprss1} {$discountpr}   {$orderby} "; 
