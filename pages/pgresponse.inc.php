...
$URL=URL;
	...
	{
	    $paytpemail="Paytm";
	$sqlupdate123=mysqli_query($conn,"update ".$sufix."order set remarks='Order Approved', reference_id='".$_POST['TXNID']."', approve_status='Order Approved', onlinemode='ccavenue' where oid='".$_SESSION['oid']."'");
?>
...
?>
        ...
        <div class="col-sm-10 text-right col-xs-8" style="padding:0">
          <div class="detail-total_col"><strong>COD Charges:</strong></div>
        </div>
        <div class="col-sm-2 col-xs-4" style="padding:0">
          <div class="detail-total_col text-center"><?php echo Currency;?> 50</div>
        </div>
        <div class="col-sm-10 col-xs-8 text-right" style="padding:0">
...
?></div>
      ...
      <div class="col-sm-4 col-md-6 col-xs-12 pull-right" style="padding:0; margin-top:10px;">
              <form  style="text-align:left; background: margin:0; border:0;">
                <a class="btn btn-primary pull-left" href="<?php echo URL;?>/" >Go to home page</a> 
