...
$sql_pro="select * from ".$sufix."product where displayflag='1' and vartype='' and bid='".$bid."' {$brand} {$color_filter} {$attribute_filter}  {$minprss1} {$maxprss1} {$discountpr} {$gender1}   {$orderby} "; 
...
<!-- =====  BREADCRUMB STRAT  ===== -->
    <div class="breadcrumb section pt-60 pb-60">
      <div class="container">
        <h1 class="uppercase"><?php echo $bidrow['brandname']; ?></h1>
        <ul>
            <li><a href="<?php echo URL; ?>"><i class="fa fa-home"></i></a></li> 
            <li><a href="<?php echo URL; ?>"><?php echo $bidrow['brandname']; ?> </a></li> 
        </ul>
      </div>
    </div>
    <!-- =====  BREADCRUMB END===== -->
