...
$address_id = $roworder['address_id'];
$sqladdress = mysqli_fetch_assoc(mysqli_query($conn,"select * from `".$sufix."customer_address` where id='".$address_id."'")) ;

$delivery_date = $roworder['delivery_date'];  

$sql_slot = mysqli_fetch_assoc(mysqli_query($conn,"select delivery_slot from ".$sufix."shipping_slot where id='".$roworder['delivery_slot']."'"));
          ...
          <tbody>
            ...
            <tr>
              <td align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="15" cellspacing="0">
                  <tbody>
                    <tr>
                <td width="60%" align="left" valign="top" style="color:#002b4f; "> Dear '.$suppliername.', <br>
                        You have a new order on shopurneeds.com/!</td>
            ...
            <tr>
              <td><table width="100%" border="0" align="center" cellpadding="15" cellspacing="0">
                  <tbody>
                    <tr>
                      <td style="padding:5px 15px;font-size:13px;color:#00295e;line-height:17px">We will share the tracking details with you shortly once your Order is Shipped.In case of any queries, please feel free to contact us at + 91  9711567607 between <span class="aBn" data-term="goog_118579533" tabindex="0"><span class="aQJ">Monday</span></span> to <span class="aBn" data-term="goog_118579534" tabindex="0"><span class="aQJ">Saturday</span></span> <span style="display:inline-block"><span class="aBn" data-term="goog_118579535" tabindex="0"><span class="aQJ">10:00 AM – 7:00 PM(IST)</span></span>.</span>You may also email us at <a href="mailto:care@https://localhost/project/shopurneeds" target="_blank">care@https://localhost/project/shopurneeds</a>.<br>
                        <br>
                      ...
                      <td align="left" valign="top"><table width="100%" border="1" cellspacing="0" cellpadding="5">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td style="font-size:12px;color:#002b4f">'.Currency.floor($_SESSION['couponcartvalue']*$_SESSION['conratio']).'</td>
                            </tr>
                            <tr>
                              <td colspan="2"></td>
                            ...
                            if($_SESSION['user_wallet_amount'] > 0)
                            {
                                $messagec .='<tr>
                                  <td colspan="2"></td>
                            ...
                            $messagec .='<tr>
                              ...
                              <th align="left" style="font-size:12px;color:#002b4f">'.Currency.floor($_SESSION['totalpaybleamount']).'</th>
                            </tr>
                          </tbody>
                        </table></td>
                    </tr>
                      ...
                      <td align="left" valign="top" width="50%" style="padding-bottom:20px"><table width="100%" cellpadding="5" style="border:3px solid white" cellspacing="0">
                                  <tbody>
                                    <tr valign="top" style="min-height:80px">
                                      <td style="font-weight:600;font-size:15px;color:#002b4f;height:20px;background-color:white" valign="middle">Billing Information:</td>
                                    </tr>
                                    <tr>
